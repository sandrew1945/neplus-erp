...
public class Reflections
{
	 ...
	 * LastUpdate  : 2010-3-19
	 * @param fieldName		字段名
	 * @return
	 */
	public static String getMethodOfGetByFieldName(final String fieldName)
	{
		return getBeanMethodByFieldName(fieldName, GETTER_PREFIX);
	}
	...
	{
		return getBeanMethodByFieldName(fieldName, SETTER_PREFIX);
	}
	 ...
	 * LastUpdate  : 2010-3-19
	 * @param fieldName		字段名
	 * @param methodPrefix	方法前缀 如set,get
	 * @return
	 */
