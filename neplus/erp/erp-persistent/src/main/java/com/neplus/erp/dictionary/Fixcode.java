...
public enum Fixcode implements BaseEnum
{
    ...
    TASK_STATUS_DOC_ARCHIVE(2006, 20061002, "文件归档"),
    TASK_STATUS_INVOICE_ARCHIVE(2006, 20061003, "票据归档"),
    TASK_STATUS_SELF_EXAM(2006, 20061004, "自审通过"),
    TASK_STATUS_DRAFT(2006, 20061005, "草稿创建"),
